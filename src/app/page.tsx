...
export default function LandingPage() {
  ...
  const [site, setSite] = useState<Record<string, string>>({
    ...
    ctaText: "Commencer", primaryColor: "#A855F7",
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/5 backdrop-blur-xl bg-black/90">
        <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button asChild className="bg-[#A855F7] hover:bg-[#A855F7]/80 text-white text-sm font-normal tracking-wide uppercase px-6 h-10 rounded-none">
              <Link href="/signup">Rejoindre</Link>
            </Button>
          </div>
          <div className="md:hidden">
            <Button asChild size="sm" className="bg-[#A855F7] hover:bg-[#A855F7]/80 text-white text-xs font-normal tracking-wide uppercase rounded-none">
              <Link href="/signup">Rejoindre</Link>
            </Button>
          </div>
        </div>
      ...
      <section className="relative min-h-[80vh] flex items-center">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 py-16 md:py-24">
          <div className="max-w-3xl space-y-8">
            <p className="text-sm font-light tracking-[0.3em] uppercase text-[#A855F7]">Sport &middot; Danse &middot; Rencontres</p>
      ...
      <section id="method" className="py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-xl mb-12">
            <p className="text-sm font-light tracking-[0.3em] uppercase text-[#A855F7] mb-3">Méthode</p>
      ...
      <section id="activities" className="py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12 gap-4">
            <div>
              <p className="text-sm font-light tracking-[0.3em] uppercase text-[#A855F7] mb-3">Activités</p>
              ...
              <div key={activity.id} className="relative bg-[#0A0A0A] group cursor-pointer overflow-hidden" onMouseEnter={() => setHoveredActivity(activity.id)} onMouseLeave={() => setHoveredActivity(null)}>
                ...
                <div className="p-4 md:p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-[10px] tracking-widest uppercase font-light ${activity.type === 'dance' ? 'text-[#A855F7]' : 'text-white/30'}`}>{activity.type === 'dance' ? 'Danse' : 'Sport'}</span>
                  </div>
                </div>
                <div className={`absolute inset-0 border transition-all duration-500 pointer-events-none ${hoveredActivity === activity.id ? 'border-[#A855F7]/50' : 'border-transparent'}`} />
              </div>
            ))}
          </div>
          {/* Level matching */}
            ...
            <div className="flex gap-6">
              {['Débutant', 'Intermédiaire', 'Avancé'].map((level) => (
                <div key={level} className="text-center group cursor-pointer">
                  <div className="h-14 w-14 border border-white/10 group-hover:border-[#A855F7] transition-colors duration-300 flex items-center justify-center mb-2">
                    <span className="text-xs font-light text-white/30 group-hover:text-[#A855F7] transition-colors uppercase">{level.charAt(0)}</span>
                  </div>
      ...
      <section id="stories" className="py-16 md:py-24 border-t border-white/5">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-xl mb-12">
            <p className="text-sm font-light tracking-[0.3em] uppercase text-[#A855F7] mb-3">Témoignages</p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-sm font-light tracking-[0.3em] uppercase text-[#A855F7] mb-3">Couverture</p>
      ...
      <section className="py-16 md:py-24 border-t border-white/5">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-3xl">
          <p className="text-sm font-light tracking-[0.3em] uppercase text-[#A855F7] mb-4">Partenaires</p>
