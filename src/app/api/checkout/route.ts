...
import { DEFAULT_PACKAGES, loadPackages, getDb } from '@/lib/payment/packages';
...
// V406 : le catalogue vit desormais dans `@/lib/payment/packages` — partage
// avec le chemin Mobile Money (pawaPay), pour qu'un forfait ne puisse pas
// avoir deux prix selon le bouton clique. Contenu repris a l'identique.
