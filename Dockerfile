...
# Sous-chemin de service. Vide pour spordateur.com (racine), "/rencontre" pour
# l'app servie sous afroboost.com. Doit etre present au BUILD : Next.js fige
# basePath/assetPrefix dans le bundle, une variable posee a l'execution arrive
# trop tard.
ARG NEXT_BASE_PATH
